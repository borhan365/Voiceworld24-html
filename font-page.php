...
?>
    ...
    <section class="azad-section azad-tabs-section">
        <div class="azad-container">
			<a href="https://voiceworld24.com/category/%E0%A6%B6%E0%A6%B0%E0%A6%A3%E0%A6%BE%E0%A6%B0%E0%A7%8D%E0%A6%A5%E0%A7%80/"><h3 style="font-weight: bold; font-size: 20px; color: #dd3432;">শরণার্থী</h3></a>
    ...
    <section class="azad-section azad-double-posts">
        <div class="azad-container">
			<div class="azad-double-posts-row">
				<div class="azad-tabs-container">		
					<div class="azad-single-post">
					<h3 style="font-weight: bold; font-size: 20px;"><a href="https://voiceworld24.com/category/%E0%A6%9C%E0%A6%BE%E0%A6%A4%E0%A7%80%E0%A7%9F/">জাতীয়</a></h3>
						<?php
						$args = array(
							'post_type' 		=> 'post',
							'posts_per_page' 	=> 1,
				...
				<div class="azad-tabs-container">		
					<div class="azad-single-post">
						<h3 style="font-weight: bold; font-size: 20px;"><a href="https://voiceworld24.com/category/%E0%A6%86%E0%A6%A8%E0%A7%8D%E0%A6%A4%E0%A6%B0%E0%A7%8D%E0%A6%9C%E0%A6%BE%E0%A6%A4%E0%A6%BF%E0%A6%95/">আন্তর্জাতিক</a></h3>
						<?php
							$args = array(
							'post_type' 		=> 'post',
							'posts_per_page' 	=> 1,
    ...
    <section class="azad-section azad-bottom-posts">
        <div class="azad-container">
			<a href="https://voiceworld24.com/category/%E0%A6%9B%E0%A6%AC%E0%A6%BF/"><h3 style="font-weight: bold; font-size: 20px">ছবি</h3></a>
			<div class="azad-bottom-posts-container">
				...
				<div class="azad-category-post">
				<a href="https://voiceworld24.com/category/videonews/"><h3 style="font-weight: bold; font-size: 20px">ভিডিও</h3></a>			
					<?php 
						$args = array(
							'post_type' 		=> 'post',
							'post_status'       =>'publish',
						...
						$custom_cat = new WP_Query( $args );
						
					if ( $custom_cat->have_posts() ) : ?>
						<?php while ( $custom_cat->have_posts() ) : $custom_cat->the_post(); ?>				
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'azad-article' ) ?>>						
								<div class="post-header">
									<figure>
						...
						<?php wp_reset_postdata(); ?>
					<?php else : ?>
						<p><?php _e( 'Sorry, no posts found in this category.', AZAD_NEWS_TEXTDOMAIN ); ?></p>
					<?php endif; ?>
				</div>
			</div>
		</div>
